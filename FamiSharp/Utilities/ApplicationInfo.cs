...
{
	public sealed class ApplicationInfo(string name, string ver, string desc, string cpr)
	{
		...
		public static ApplicationInfo GetApplicationInfo()
		{
			...
			return new ApplicationInfo(fileVersionInfo.ProductName!, fileVersionInfo.ProductVersion!, fileVersionInfo.Comments!, fileVersionInfo.LegalCopyright!);
		}
	}
}
